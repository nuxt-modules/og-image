...
<template>
  <div class="h-full w-full flex flex-col relative overflow-hidden bg-neutral-50">
    <!-- Paper texture -->
    ...
    <div class="px-12 pt-6 pb-4 border-b-2 border-black">
      <div class="flex items-end justify-between">
        <p class="text-sm leading-1.5 tracking-[0.2em] uppercase text-neutral-500">
          {{ formattedDate }}
        </p>
        <h2 class="text-4xl leading-1 font-bold tracking-tight text-black uppercase italic" style="line-height: 20px;">
          {{ publication }}
        </h2>
        <p v-if="category" class="text-sm leading-1.5 tracking-[0.2em] uppercase text-neutral-500">
          {{ category }}
        </p>
      </div>
    </div>
    ...
    <div class="flex-1 flex items-center px-16 py-12">
      <h1
        class="text-[72px] font-bold text-black leading-[1.05] tracking-tight text-center w-full"
    ...
    <div class="px-16 pb-12">
      <div class="flex items-center gap-6">
        <div class="flex-1 h-[1px] bg-neutral-400" />
