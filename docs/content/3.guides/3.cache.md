...
If you have `@nuxthub/core` installed and KV enabled, the module will automatically use your KV storage for the runtime cache. You need no extra configuration if you set `runtimeCacheStorage` to `true` (default).
