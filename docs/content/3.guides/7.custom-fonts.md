...
relatedPages:
  - path: /docs/og-image/guides/emojis
    title: Emojis
  - path: /docs/og-image/guides/non-english-locales
...
Nuxt OG Image needs a `@nuxt/fonts` version with the `fonts:resolved` hook. With an older version, OG images use the bundled Inter font.
