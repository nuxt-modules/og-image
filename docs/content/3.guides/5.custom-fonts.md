...
Inter (400 and 700) is bundled and works out of the box with zero configuration.

For any other font, Nuxt OG Image uses the [@nuxt/fonts](https://fonts.nuxt.com) module. **No other method of loading custom fonts is supported.**
