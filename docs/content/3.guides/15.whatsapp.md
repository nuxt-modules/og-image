...
relatedPages:
  - path: /docs/og-image/api/define-og-image
    title: defineOgImage()
  - path: /docs/og-image/guides/resolve-og-images
...
- `/_og/d/title_My+Page,p_...` (default)
- `/_og/d/k_whatsapp,w_800,h_800,title_My+Page,p_...`
...
//   '/_og/d/k_square,w_450,h_450,title_Default,p_...'
// ]
</script>
```
