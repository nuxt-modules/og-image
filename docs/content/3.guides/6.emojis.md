...
Control how the module resolves emojis with the `emojiStrategy` option:
...
- **`auto`** (default): Uses local if you install `@iconify-json/{emoji-family}`, otherwise fetches from API
