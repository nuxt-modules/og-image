...
::tip
**Prerendered images are unaffected.** The module automatically switches to short hash-based URLs (`/_og/s/o_1whacq.png`) for any path over 200 characters, or any path that holds a comma, a plus sign, or another reserved character.
::
