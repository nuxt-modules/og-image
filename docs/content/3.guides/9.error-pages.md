...
Note that the module only supports displaying OG Images for error pages with status codes ranging 400 to 499. Pages with status codes >= 500 won't generate an OG Image.
