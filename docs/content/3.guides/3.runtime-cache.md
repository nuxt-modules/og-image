...
When generating images at runtime, Nuxt OG Image provides two layers of caching to minimize server load and response times. For most deployments, the defaults work well and require no configuration.
