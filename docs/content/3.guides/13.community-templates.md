...
Use this guide only when you are using a named community template such as `NuxtSeo`. If you only need normal page OG images, start with [`defineOgImage`](/docs/og-image/api/define-og-image) instead.
...
to let you customize it however you like.

Like all Community templates, it's recommended to copy+paste it into your project if you want to customize it. You can find
