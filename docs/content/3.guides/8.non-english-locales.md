...
relatedPages:
  - path: /docs/og-image/guides/custom-fonts
    title: Custom Fonts
  - path: /docs/og-image/integrations/i18n
    title: Nuxt I18n
...
::note
With the [Satori](/docs/og-image/renderers/satori) renderer, characters that no configured font covers load a matching Noto font from Google Fonts on demand. Configure a font yourself when you want to choose the typeface or keep font requests off Google. See [`missingGlyphFonts`](/docs/og-image/api/config#missingglyphfonts).
::
