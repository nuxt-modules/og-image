...
relatedPages:
  - path: /docs/og-image/guides/styling
    title: Styling
  - path: /docs/og-image/guides/performance
    title: Performance
...
**Image resolution:** image paths must be either relative to the `public` directory or absolute. It's not possible to bundle images
...
This will save render time as it won't need to fetch the image. See the [Performance](/docs/og-image/guides/performance#optimize-components) guide for more tips.
