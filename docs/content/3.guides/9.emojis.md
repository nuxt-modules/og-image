...
For faster rendering without network requests ([Performance](/docs/og-image/guides/performance#optimize-components)), install the iconify package for your emoji family:
