...
- **Avoid dynamic images**: use static, statically-analysable image sources where possible. Dynamic image URLs trigger runtime fetches (100-500ms each) and dimension detection. Static sources can be resolved at build time.
