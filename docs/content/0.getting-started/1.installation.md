...
Install renderer dependencies separately. We recommend [Takumi](/docs/og-image/renderers/takumi) - it's 2-10x faster than Satori with the same feature set.
