...
Nuxt OG Image generates social media preview images (og:image) using Vue templates. Images are rendered at build time or on-demand using [Takumi](/docs/og-image/renderers/takumi) (recommended), [Satori](/docs/og-image/renderers/satori), or [Browser](/docs/og-image/renderers/browser).
