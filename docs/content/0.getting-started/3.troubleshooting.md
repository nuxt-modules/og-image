...
If your runtime OG image URLs are long (500+ characters), this is expected in v6 - all options are encoded directly in the URL path for stateless CDN caching. See the [Performance](/docs/og-image/guides/performance) guide for strategies to reduce URL size and optimise rendering.
