...
To ensure the tags get rendered, you need to use the `defineOgImage()`{lang="ts"} composable with the `ogImage` key.
...
**Screenshots:** to use screenshots for content pages, set the component to use the browser renderer in your frontmatter:
