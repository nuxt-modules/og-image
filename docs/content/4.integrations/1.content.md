...
When you configure `strictNuxtContentPaths`, the module automatically generates images for each markdown file in your content folder.
...
If you'd prefer to render screenshots, you can use the`<OgImageScreenshot />`{lang="vue"} component within your content instead of using
frontmatter.
