...
- **Nuxt UI v3**: the module resolves semantic colors (`primary`, `secondary`, etc.) automatically
...
Fonts need the `global: true` option to be available in OG image rendering.
