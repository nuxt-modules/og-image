...
relatedPages:
  - path: /docs/og-image/migration-guide/v6
    title: v5 to v6
  - path: /docs/og-image/renderers/takumi
    title: Takumi Renderer
  - path: /docs/og-image/releases/v5
    title: v5.0.0
---
...
- `defineOgImageComponent` deprecated in favor of [`defineOgImage`](/docs/og-image/api/define-og-image) ([#433](https://github.com/nuxt-modules/og-image/pull/433))
