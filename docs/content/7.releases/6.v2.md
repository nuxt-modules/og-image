...
relatedPages:
  - path: /docs/og-image/releases/v3
    title: v3.0.0
  - path: /docs/og-image/guides/custom-fonts
    title: Custom Fonts
  - path: /docs/og-image/guides/runtime-cache
    title: Runtime Cache
---
...
I'm happy to move on from debugging Wasm issues on different edge providers...
...
While this sounds like a small change, it's required a complete rewrite of the module.

Using this is zero-config, deploy your app using `nuxt build` and it will work for the following providers:
