...
The v4 major of Nuxt OG Image is a simple release to remove deprecations and add support for the [Nuxt SEO v2 stable](https://nuxtseo.com/releases).

## :icon{name="i-noto-warning"} Breaking Features

**Site Config v3:** Nuxt Site Config is a module used internally by Nuxt OG Image.
