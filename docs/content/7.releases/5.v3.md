...
Whenever you add a template has a `<style>`{lang="html"} block, we need to use the [css-inline](https://github.com/Stranger6667/css-inline) dependency to make sure
