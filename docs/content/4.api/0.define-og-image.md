...
defineOgImage({
  component: 'MyCustomComponent.takumi',
  title: 'Hello'
})
```
...
Pass shared props as the second argument and an array of size/key variants as the third. Props are shared across all variants — no duplication needed:
