...
relatedPages:
  - path: /docs/og-image/api/define-og-image-component
...
::deprecated
Configure fonts via [`@nuxt/fonts`](https://fonts.nuxt.com) instead. The module automatically detects and uses fonts from `@nuxt/fonts`.
::
