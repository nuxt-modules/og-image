...
relatedPages:
  ...
  - path: /docs/og-image/migration-guide/v6
    title: v5 to v6
  - path: /docs/og-image/guides/whatsapp
    title: WhatsApp & Multiple Images
---

::deprecated
**Deprecated in v6.** Use [`defineOgImage()`{lang="ts"}](/docs/og-image/api/define-og-image) instead with the component name as the first argument.
```ts
// Before
...
// urls = [
//   '/_og/d/title_Default,p_...',
//   '/_og/d/k_square,w_450,h_450,title_Square,p_...'
// ]
```
