...
| **Edge Runtime** | ✅ | ✅ | ❌ |
| **CSS Support** | Comprehensive | Partial | Full |
| **Gradients** | ✅ | ✅ | ✅ |
| **Opacity** | ✅ | ✅ | ✅ |
| **Flexbox** | ✅ | ✅ | ✅ |
| **CSS Grid** | ✅ | ❌ | ✅ |
...
| **Transforms** | ✅ 2D | ❌ | ✅ |
| **Filters** | ✅ | ❌ | ✅ |
| **Emoji** | ✅ COLR fonts | ✅ 6 families | ✅ |
| **Fonts** | WOFF2, variable | Google Fonts, local | Any |
| **Dependencies** | `@takumi-rs/core` | Built-in | `playwright` |
...
Takumi is the recommended renderer. It's 2-10x faster than Satori with comprehensive CSS support including gradients, shadows, opacity, CSS Grid, transforms, and filters:
